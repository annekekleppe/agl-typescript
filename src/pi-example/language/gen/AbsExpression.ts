 ...
 */
@model
export class AbsExpression extends ExExpression implements PiExpression {
    /**
    ...
    readonly $typename: ExampleMetaType = "AbsExpression"; // holds the metatype in the form of a string

    expr: ExExpression; // implementation of part 'expr'
