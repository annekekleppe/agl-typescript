...
import { Type, ExampleMetaType } from "./internal";
 ...
 */
@model
export class AttributeType extends MobxModelElementImpl implements PiNamedElement, Type {
    /**
    ...
    readonly $typename: ExampleMetaType = "AttributeType"; // holds the metatype in the form of a string
    $id: string; // a unique identifier
    @observable name: string = ""; // implementation of name
    @observable extra: number = 0; // implementation of extra
