 ...
 */
@model
export abstract class LiteralExpression extends ExExpression implements PiExpression {
    readonly $typename: ExampleMetaType = "LiteralExpression"; // holds the metatype in the form of a string
