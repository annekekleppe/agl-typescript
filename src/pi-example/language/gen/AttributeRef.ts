...
import { AppliedFeature, Attribute, ExampleMetaType, PiElementReference } from "./internal";
...
export class AttributeRef extends AppliedFeature implements PiElement {
    ...
    readonly $typename: ExampleMetaType = "AttributeRef"; // holds the metatype in the form of a string

    attribute: PiElementReference<Attribute>; // implementation of reference 'attribute'
