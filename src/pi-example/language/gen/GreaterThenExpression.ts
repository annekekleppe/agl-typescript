...
import { ComparisonExpression, ExampleMetaType, ExExpression } from "./internal";
...
export class GreaterThenExpression extends ComparisonExpression implements PiBinaryExpression {
    ...
    readonly $typename: ExampleMetaType = "GreaterThenExpression"; // holds the metatype in the form of a string
